    ...
    <SafeAreaView style={[readerStyles.safe, darkMode && readerDarkStyles.safe]}>
      <View style={[readerStyles.container, darkMode && readerDarkStyles.container]}>
        ...
        >
          ...
          <View style={{justifyContent: 'center', marginTop: 12, marginBottom: 12}}>
            <AppText style={[readerDarkStyles.langPickerBtnText, {fontSize: 16.67}]}>
              All simplified text and complex word definitions are generated by AI. Each new scan or simplification may produce slightly different results.
            </AppText>
          </View>
        </ScrollView>

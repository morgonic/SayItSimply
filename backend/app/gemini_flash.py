...
async def get_gemini_response(
    ...
    system_instructions = (
        ...
        "<output_format>\n"
        "You must produce one single object that matches the structure of the provided response JSON schema.\n"
        "</output_format>\n\n"
        ...
        "- Each action item must be formatted as an actionable instruction. Use context to reword actions into an instruction if needed.\n"
        "- Include a deadline with the action item if applicable, in ISO format YYYY-MM-DD. If there is no deadline applicable, set the deadline to null.\n\n"
        ...
        "- Output complex_words as a list of objects.\n"
        "- Each object in complex_words must contain exactly two fields: word and definition.\n"
        "- word: the complex word from the input_text.\n"
        "- definition: a short, simple, plain-language definition of that word.\n"
        "- Preserve the order the words first appear in the original text.\n"
        "- Do not capitalize words unless they are proper nouns.\n"
        "- Do not include the word inside the definition text.\n"
        ...
        "- ONLY extract words that are deemed more complex than the provided base_reading_level_grade.\n"
        "- Output simple_words as a list of objects.\n"
        "- Each object in simple_words must contain exactly two fields: word and definition.\n"
        "- word: the complex word from the input_text.\n"
        "- definition: a short, simple, plain-language definition of that word.\n"
        "- Preserve the order the words first appear in the original text.\n"
        "- Do not capitalize words unless they are proper nouns.\n"
